    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-4 mb-3">
                <div class="col-span-6 text-xl text-gray-800">{{ __('Access') }} &raquo; {{ __('Role') }} &raquo; {{ __('Create') }}</div>
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-9">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="rolename" type="text" value="{{ old('rolename') }}">
                                    @error('rolename')
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="checkbox" id="default" name="default" value="1"> Set this role upon register
                                    @error('default')
                                        ...
                                        @foreach ($lists as $name => $list)
                                            <div>
                                                ...
                                                @foreach ($list as $permission)
                                                    <input type="checkbox" name="rolepermission[]" value="{{ $permission['name'] }}" {{ (is_array(old('rolepermission')) && in_array($permission['name'], old('rolepermission'))) ? ' checked' : '' }}>
