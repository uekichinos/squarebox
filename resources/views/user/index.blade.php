    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-4 mb-3">
                <div class="col-span-6 text-xl text-gray-800">{{ __('Access') }} &raquo; {{ __('User') }}</div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-2">
                            @can('Create User')
                                <button onclick="location.href='{{ route('user.create') }}'" class="bg-gray-700 hover:bg-gray-500 text-white py-2 px-4 border border-gray-700 rounded mb-5 w-auto text-center">
